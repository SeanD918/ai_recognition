...
MODEL_PTH_PATH = os.path.join(SCRIPT_DIR, "saved_models", "animal_model.pth")
MODEL_KERAS_PATH = os.path.join(SCRIPT_DIR, "saved_models", "animal_model.keras")
CLASSES_PATH = os.path.join(SCRIPT_DIR, "saved_models", "classes.json")
